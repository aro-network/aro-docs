...
> **Warning**: <span style="color:red">The imaging process will erase all data on the USB drive. If the USB contains important data, please back it up before proceeding.</span>
...
> **Warning**: <span style="color:red">The physical host for the installation must be connected to the internet via an Ethernet cable.</span>
