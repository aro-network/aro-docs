...
### **My Dashboard->Node Detail page shows error message: "Auto-sleep detected on host machine."**  
  We have detected that your host machine OS has inappropriate sleep settings. This may lead to auto-sleep of your node. Follow the <Link to="/node-operator-guide/aro-client/aro-client-debian#51-auto-sleep-auto-start-and-power-mode-settings">Auto-sleep settings tutorial</Link> and update your settings.
